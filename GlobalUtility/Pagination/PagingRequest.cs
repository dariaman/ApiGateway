...
namespace GlobalUtility.Pagination
{
    public class PagingRequest
    {
        ...
        // ===================== Harusnya pipndah ke file baru untuk validasi =================================================================================================
        ...
        static List<string> SearchValidate(SearchCriteria? _search, PropertyInfo? prop)
        {
            ...
            if (!Enum.TryParse(typeof(OperatorEnum), _search.Operator, true, out _)) searchErrorList.Add("The Operator field is invalid");
